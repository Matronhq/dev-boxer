...
Run: `cd /home/youruser/projects/dev-boxer && rake test TESTOPTS='--name=test_wizard_writes_config_and_secrets'`
...
Run: `cd /home/youruser/projects/dev-boxer && rake test`
...
```bash
cd /home/youruser/projects/dev-boxer
git -c user.name="Dan Barker" -c user.email="dan@example.com" add lib/dev_boxer/wizard.rb test/wizard_test.rb
git -c user.name="Dan Barker" -c user.email="dan@example.com" commit -m "Preface server-login prompts with prose explanations
...
cd /home/youruser/projects/dev-boxer
git -c user.name="Dan Barker" -c user.email="dan@example.com" add lib/dev_boxer/wizard.rb test/wizard_test.rb
git -c user.name="Dan Barker" -c user.email="dan@example.com" commit -m "Rewrite domain-and-DNS wizard prefaces as prose
...
cd /home/youruser/projects/dev-boxer
git -c user.name="Dan Barker" -c user.email="dan@example.com" add lib/dev_boxer/wizard.rb test/wizard_test.rb
git -c user.name="Dan Barker" -c user.email="dan@example.com" commit -m "Rewrite Cloudflare tunnel/Access wizard prefaces as prose
...
Run: `cd /home/youruser/projects/dev-boxer && rake test TESTOPTS='--name=/wizard/'`
...
cd /home/youruser/projects/dev-boxer
git -c user.name="Dan Barker" -c user.email="dan@example.com" add lib/dev_boxer/wizard.rb test/wizard_test.rb
git -c user.name="Dan Barker" -c user.email="dan@example.com" commit -m "Preface Matrix prompts with prose explanations
...
cd /home/youruser/projects/dev-boxer
git -c user.name="Dan Barker" -c user.email="dan@example.com" add lib/dev_boxer/wizard.rb test/wizard_test.rb
git -c user.name="Dan Barker" -c user.email="dan@example.com" commit -m "Move Claude-behavior summary into explain_claude_experience_level
...
```bash
cd /home/youruser/projects/dev-boxer && ruby -e '
...
Run: `cd /home/youruser/projects/dev-boxer && grep -nE "puts \"  (What|Why|How|Tip|Cost|Link|Scope|Alternative|Manual option|Login|Access|Tunnel|Cleanup): " lib/dev_boxer/wizard.rb`
